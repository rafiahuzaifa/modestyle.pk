...
const SOCIAL_LINKS = [
  {
    name: "Instagram",
    href: "https://instagram.com/modestyle.pk",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://facebook.com/modestyle.pk",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "TikTok",
    href: "https://tiktok.com/@modestyle.pk",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="bg-secondary text-white">
      ...
      <div className="border-b border-white/10">
        <div className="container mx-auto px-4 py-12 text-center">
          <p className="text-gold-400 text-xs tracking-[0.3em] uppercase mb-2">Stay Connected</p>
          ...
          {subscribed ? (
            <div className="max-w-md mx-auto bg-gold-500/20 border border-gold-500/30 rounded-lg px-6 py-4 text-gold-300 text-sm">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="flex gap-3">
              {SOCIAL_LINKS.map((s) => (
                <a
                  ...
                  aria-label={s.name}
                  className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center hover:border-gold-500 hover:text-gold-400 transition text-white/60"
                >
                  {s.icon}
                </a>
              ))}
          ...
          {Object.entries(FOOTER_LINKS).map(([title, links]) => (
            <div key={title}>
              <h4 className="text-xs font-medium tracking-[0.2em] uppercase text-gold-400 mb-4">
                {title}
              </h4>
      ...
      {/* Bottom */}
      <div className="border-t border-white/10">
        <div className="container mx-auto px-4 py-5 flex flex-col md:flex-row justify-between items-center text-xs text-white/30 gap-2">
          <p>&copy; {new Date().getFullYear()} ModestStyle.pk. All rights reserved.</p>
